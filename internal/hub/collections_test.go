...
func TestCollectionRulesDefault(t *testing.T) {
	...
	providerURLField := systemsCollection.Fields.GetByName("provider_url")
	require.NotNil(t, providerURLField, "systems collection should have provider URL field")
	assert.Equal(t, core.FieldTypeURL, providerURLField.Type())
